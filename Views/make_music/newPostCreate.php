...
{
    $createPost = $insertPost->createPostCtl();
...
<form action="" method="POST">
    <input name="user_id" type="hidden" value=<?php echo $post['user_id'] ?>>
    <input name="name" type="hidden" value=<?php echo $post['name'] ?>>
<table>
    <tr>
        <td>使用キー</td>
